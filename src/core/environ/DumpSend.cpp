...
struct zlib_inmem_func64 : public zlib_filefunc64_def {
    ...
    zlib_inmem_func64() {
        ...
        zread_file = (read_file_func)fread_file_func;
        zwrite_file = (write_file_func)fwrite_file_func;
        ztell64_file = (tell64_file_func)ftell64_file_func;
        zseek64_file = (seek64_file_func)fseek64_file_func;
